...
/**
 * Sample dependency in the [ScopeOne] scope that will be started when the
 * [com.victorrendina.dagger2.lifecycle.sample.di.components.ScopeOneComponent] is initialized and
 * automatically disposed of when the component is disposed.
 */
@ScopeOne
@DaggerLifecycle
class SampleDepOne @Inject constructor() : AutoStart, AutoDispose {
    override fun start() {
